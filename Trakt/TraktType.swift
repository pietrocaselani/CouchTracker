...
func stubbedResponse(_ filename: String) -> Data {
  ...
  var bundle = Bundle(path: resourcesPath.appending("/../Trakt-Tests-Resources.bundle"))
  if bundle == nil {
    bundle = Bundle(path: resourcesPath.appending("/../../Debug/Trakt-Tests-Resources.bundle"))
  }
